...
root.title('COD_Reminder_Process')
...
def proc1():
    ...
    # out_iter_folder = out_namespace.Folders['SSC.bayplan@cma-cgm.com'].Folders['Sent Items']
    out_iter_folder = out_namespace.Folders['ssc.cod@cma-cgm.com'].Folders['Sent Items']
    ...
    for id,rw in df.iterrows():
        try:
            ...
            ou1 = dk[dk['Sub_'].str.contains(Subj,regex=False)]
            
            if len(ou1)>0:
                print("found...Subject")
                ou2 = ou1[ou1['Sub_'].str.contains('$',regex=False)]
                ...
                if len(ou2) >0:
                    ...
                    BodyN =  'Dear Partners,<br>Good Day,<br><br>Can you please advise the feasibility restow count Port of restow and deadline to confirm the below COD.<br>'
