...
class Baltice_e():
    def Eurogate_E():
        with urllib.request.urlopen('https://www.eurogate.de/eportal/state/show?_state=1qb0ss331qifw&_unique=lue9ea60i4zv&_transition=start') as response:
        ...
        nDf.to_excel(file_name,index=False,sheet_name='Baltic_e_eurogate')
        file_name.save()            
